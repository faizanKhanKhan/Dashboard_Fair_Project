      ...
      <div className={styles.header}>
        <div className={styles.left}>
          ...
          <button onClick={handleNextButtonClick}>
            {isAuthenticated ? "Manage your Projects" : "Get Login"}{" "}
            <ArrowRight />{" "}
          </button>
          <button onClick={handleNextButtonClick}>
            {isAuthenticated ? "Get Analytics" : "Get Analytics"}{" "}
            <ArrowRight />{" "}
          </button>
          <button onClick={handleNextButtonClick}>
            {isAuthenticated ? "Add Associate" : "Add Associate"}{" "}
            <ArrowRight />{" "}
          </button>
          <button onClick={handleNextButtonClick}>
            {isAuthenticated ? "My Account Info" : "My Account Info"}{" "}
            <ArrowRight />{" "}
          </button>
          <button onClick={handleNextButtonClick}>
            {isAuthenticated ? "Project Allocation" : "Project Allocation"}{" "}
            <ArrowRight />{" "}
          </button>
